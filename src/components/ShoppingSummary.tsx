    ...
    <div className="min-h-screen flex flex-col items-center px-6 py-10 gradient-surface">
      <div className="max-w-lg w-full">
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.05 }}>
          <span className="font-mono text-xs text-primary tracking-[0.2em] uppercase block mb-2">Summary</span>
        ...
        <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.08 }}
          className="bg-card rounded-xl border border-border p-4 mb-4 flex items-start gap-3"
        >
        ...
        {/* Best Next Purchase — hero card */}
        <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.12 }}
          className="gradient-verdict rounded-2xl border-2 border-primary/20 p-6 mb-4 relative overflow-hidden"
        >
        ...
        >
          ...
          <div className="divide-y divide-border">
            ...
            <div className="flex items-center justify-between p-4 bg-status-safe/5">
              ...
              <span className="font-mono font-bold text-status-safe text-lg">RM{result.budgetAfterShopping.toFixed(2)}</span>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="bg-card rounded-xl border border-border p-4 text-center">
            ...
            <div className="flex items-center justify-center gap-1">
              ...
              <span className={`text-sm font-bold ${coverageChanged ? 'text-status-safe' : 'text-muted-foreground'}`}>
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm text-foreground font-semibold mb-1">Next move</p>
              <p className="text-xs text-muted-foreground leading-relaxed">{result.finalMessage}</p>
            </div>
          </div>
        </motion.div>
